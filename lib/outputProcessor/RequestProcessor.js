...
RequestProcessor.prototype.process = function (contextItem) {
    ...
    contextItem.toWriteList = contextItem.toWriteList || {};
    ...
    contextItem.toWriteList[prefix + 'simpleLineOption'] = simpleLineData;
    ...
    contextItem.toWriteList[prefix + 'spentByTypeOption'] = spentByTypeOption;
    ...
    contextItem.toWriteList[prefix + 'countByTypeOption'] = countByTypeOption;
